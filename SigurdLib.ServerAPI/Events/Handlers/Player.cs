...
namespace Sigurd.ServerAPI.Events.Handlers
{
    ...
    {
        /// <summary>
        /// Invoked after a <see cref="Common.Features.Player"/> joined the server, including the host.
        /// </summary>
        public static event CustomEventHandler<JoinedEventArgs> Joined;

        /// <summary>
        /// Invoked right before a <see cref="Common.Features.Player"/> leaves the server, including the local client.
        /// </summary>
        public static event CustomEventHandler<LeftEventArgs> Left;

        /// <summary>
        /// Invoked before a <see cref="Common.Features.Player"/> is hurt.
        /// </summary>
        public static event CustomEventHandler<HurtingEventArgs> Hurting;

        /// <summary>
        /// Invoked after a <see cref="Common.Features.Player"/> is hurt.
        /// </summary>
        public static event CustomEventHandler<HurtEventArgs> Hurt;

        /// <summary>
        /// Invoked before a <see cref="Common.Features.Player"/> dies.
        /// </summary>
        public static event CustomEventHandler<DyingEventArgs> Dying;

        /// <summary>
        /// Invoked after a <see cref="Common.Features.Player"/> dies.
        /// </summary>
        public static event CustomEventHandler<DiedEventArgs> Died;

        /// <summary>
        /// Invoked before a <see cref="Common.Features.Player"/> starts grabbing an <see cref="Item"/>.
        /// </summary>
        public static event CustomEventHandler<StartGrabbingItemEventArgs> StartGrabbingItem;

        /// <summary>
        /// Invoked before a <see cref="Common.Features.Player"/> completes a grab on an <see cref="Item"/>.
        /// </summary>
        public static event CustomEventHandler<GrabbingItemEventArgs> GrabbingItem;

        /// <summary>
        /// Invoked after a <see cref="Common.Features.Player"/> completes a grab on an <see cref="Item"/>.
        /// </summary>
        public static event CustomEventHandler<GrabbedItemEventArgs> GrabbedItem;

        /// <summary>
        /// Invoked before a <see cref="Common.Features.Player"/> drops an <see cref="Item"/>.
        /// </summary>
        public static event CustomEventHandler<DroppingItemEventArgs> DroppingItem;

        /// <summary>
        /// Invoked after a <see cref="Common.Features.Player"/> drops an <see cref="Item"/>.
        /// </summary>
        public static event CustomEventHandler<DroppedItemEventArgs> DroppedItem;

        /// <summary>
        /// Called after a <see cref="Common.Features.Player"/> joined the server, including the host.
        /// </summary>
        ...
        /// <summary>
        /// Called right before a <see cref="Common.Features.Player"/> leaves the server, including the local client.
        /// </summary>
        ...
        /// <summary>
        /// Called before a <see cref="Common.Features.Player"/> is hurt.
        /// </summary>
        ...
        /// <summary>
        /// Called after a <see cref="Common.Features.Player"/> is hurt.
        /// </summary>
        ...
        /// <summary>
        /// Called before a <see cref="Common.Features.Player"/> dies.
        /// </summary>
        ...
        /// <summary>
        /// Called after a <see cref="Common.Features.Player"/> dies.
        /// </summary>
        ...
        /// <summary>
        /// Called before a <see cref="Common.Features.Player"/> starts grabbing an <see cref="Item"/>.
        /// </summary>
        ...
        /// <summary>
        /// Called before a <see cref="Common.Features.Player"/> completes a grab on an <see cref="Item"/>.
        /// </summary>
        ...
        /// <summary>
        /// Called after a <see cref="Common.Features.Player"/> completes a grab on an <see cref="Item"/>.
        /// </summary>
        ...
        /// <summary>
        /// Called before a <see cref="Common.Features.Player"/> drops an <see cref="Item"/>.
        /// </summary>
        ...
        /// <summary>
        /// Called after a <see cref="Common.Features.Player"/> drops an <see cref="Item"/>.
        /// </summary>
