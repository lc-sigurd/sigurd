...
{
    /// <summary>
    /// Contains all the information after a <see cref="Common.Features.Player"/> is hurt.
    /// </summary>
    public class HurtEventArgs : System.EventArgs
    {
        ...
        public HurtEventArgs(Common.Features.Player player, int damage, bool hasSFX, CauseOfDeath causeOfDeath, int deathAnimation,
