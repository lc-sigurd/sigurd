...
public class CliConfiguration
{
    ...
    /// <returns>A parse result describing the outcome of the parse operation.</returns>
    public CliParseResult Parse(string commandLine)
    ...
    /// <returns>The exit code for the invocation.</returns>
    /// <remarks>The command line string input will be split into tokens as if it had been passed on the command line.</remarks>
    public UniTask<int> InvokeAsync(string commandLine, CancellationToken cancellationToken = default)
    ...
    /// </summary>
    /// <returns>The exit code for the invocation.</returns>
    public UniTask<int> InvokeAsync(string[] args, CancellationToken cancellationToken = default)
