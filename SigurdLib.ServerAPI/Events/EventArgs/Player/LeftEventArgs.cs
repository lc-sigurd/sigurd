...
{
    /// <summary>
    /// Contains all the information right before a <see cref="Common.Features.Player"/> leaves the server. Including the local client.
    /// </summary>
    public class LeftEventArgs : System.EventArgs
    {
        ...
        public LeftEventArgs(Common.Features.Player player)
        {
            Player = player;
        }
    }
