...
internal sealed class ProcessTerminationHandler : IDisposable
{
    ...
    internal readonly UniTaskCompletionSource<int> ProcessTerminationCompletionSource;
    private readonly CancellationTokenSource _handlerCancellationTokenSource;
    private readonly UniTask<int> _startedHandler;
    ...
    void Cancel(int forcedTerminationExitCode)
    {
        ...
        try
        {
            ...
            if (!_startedHandler.AsTask().Wait(_processTerminationTimeout))
            {
                ...
                ProcessTerminationCompletionSource.TrySetResult(forcedTerminationExitCode);
            }
        }
