...
namespace Sigurd.Common.Features
{
    public class Player : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="Player"/>'s username locally.
        /// </summary>
        ...
        /// If you set a <see cref="Player"/>'s position out of bounds, they will be teleported back to a safe location next to the ship or entrance/exit to a dungeon.
        /// </summary>
        ...
        private void Start()
        {
            PlayerController = StartOfRound.Instance.allPlayerScripts.FirstOrDefault(c => c.actualClientId == ClientId);
