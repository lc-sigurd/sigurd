...
public sealed class CliParseResult
{
    ...
    internal static CliParseResult Empty() => new CliRootCommand().Parse(Array.Empty<string>());
    ...
    /// <inheritdoc />
    public override string ToString() => ParseDiagram.Diagram(this).ToString();
    ...
    public UniTask<int> InvokeAsync(CancellationToken cancellationToken = default)
